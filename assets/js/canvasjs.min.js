/*
 CanvasJS HTML5 & JavaScript Charts - v3.3 Beta 1 - https://canvasjs.com/ 
...
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function da(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk=[];this.previousDataPointEventObject=null;this.ghostCanvas=sa(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ha(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
...
a[0].chart.width-10,a[0].bounds.height);d[0]&&e.rect(5,d[d.length-1].bounds.y1,d[0].chart.width-10,d[0].bounds.height);e.clip();if(a&&0<a.length)for(var l=0;l<a.length;l++)a[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk();if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk();e.restore();if(c&&0<c.length)for(l=0;l<c.length;l++)c[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk();if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk();f.preparePlotArea();f=f.plotArea;e.save();e.beginPath();e.rect(f.x1,
f.y1,Math.abs(f.x2-f.x1),Math.abs(f.y2-f.y1));e.clip();if(a&&0<a.length)for(l=0;l<a.length;l++)a[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("value");if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("value");if(c&&0<c.length)for(l=0;l<c.length;l++)c[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("value");if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("value");if(a&&0<a.length)for(l=0;l<a.length;l++)a[l].renderInterlacedColors();if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].renderInterlacedColors();
...
0;l<b.length;l++)b[l].renderGrid(),v&&(b[l].createMask(),b[l].renderBreaksBackground());if(a&&0<a.length)for(l=0;l<a.length;l++)a[l].renderAxisLine();if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].renderAxisLine();if(c&&0<c.length)for(l=0;l<c.length;l++)c[l].renderAxisLine();if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].renderAxisLine();if(a&&0<a.length)for(l=0;l<a.length;l++)a[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("pixel");if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("pixel");
if(c&&0<c.length)for(l=0;l<c.length;l++)c[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("pixel");if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk("pixel")};D.prototype.calculateStripLinesThicknessInValues=function(){for(var a=0;a<this.stripLines.length;a++)if(null!==this.stripLines[a].startValue&&null!==this.stripLines[a].endValue){var d=Math.min(this.stripLines[a].startValue,this.stripLines[a].endValue),c=Math.max(this.stripLines[a].startValue,this.stripLines[a].endValue),d=this.getApparentDifference(d,
...
(s(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=d),a[d].startValue>=this.conversionParameters.minimum&&(a[d].startPixel=this.convertValueToPixel(a[d].startValue),this.scaleBreaks.lastBreakIndex=d),a[d].endValue<=this.conversionParameters.maximum&&(a[d].endPixel=this.convertValueToPixel(a[d].endValue)))}};D.prototype.rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk=function(){var a=this,d=!1,c=0,b=0,e=1,f=0;0!==this.labelAngle&&360!==this.labelAngle&&(e=1.2);if("undefined"===typeof this.options.interval){if("bottom"===
...
d=e+1>this._labels.length-1?this.getPixelCoordinatesOnAxis(this.viewportMaximum):this.getPixelCoordinatesOnAxis(this._labels[e+1].position),a.fillRect(b.x1,Math.min(c.y,d.y),Math.abs(b.x1-b.x2),Math.abs(d.y-c.y)),d=!1):d=!0;a.beginPath()};D.prototype.rLKV8Ew6V8PhbxoowLwNJYrVoEmBcug6dk=function(a){if(this.stripLines&&0<this.stripLines.length&&a){for(var d=this,c,b=0,e=0,f=!1,l=!1,h=[],m=[],l=!1,b=0;b<this.stripLines.length;b++){var k=this.stripLines[b];k._thicknessType===a&&("pixel"===a&&(k.value<this.viewportMinimum||
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.3 Beta 1";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
