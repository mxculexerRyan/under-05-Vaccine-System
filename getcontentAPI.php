...
$response=callAPI('GET','http://localhost/monaco/v1/api/testing/view.php',false);
// echo $response;
// var_dump(json_decode($response, true));
$response_data = json_decode($response);
// echo $response_data;
// // $units=$response_data->request_no;
// foreach ($units as $key => $value) {
//     echo $units[$key]."\n";
// }
// var_dump($response_data);
// print_r($response_data->request_no);
// foreach($response_data as $item){
//     echo $item->request_no."\n";
// }
?>
<style>
