			...
			<div class="card-body">
				<form action="" id="manage-Invoice">
					...
					<div class="col-md-12">
								...
								<tbody>
									...
									?>
										<tr class="item-row">
											...
											<td>
												<input type="number" min="1" step="any" name="qty[]" value="<?php echo $row['item_quantity'] ?>" class="text-right">
											</td>
											<td>
						...
						<div class="row">
							<div class="col-lg-12">
								<button type="button" class="btn btn-success col-sm-3 btn-sm btn-block float-right" id='pay' >Pay</button>
					...
					<div class="modal fade" id="pay_modal" role='dialog'>
					    <div class="modal-dialog modal-md" role="document">
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-primary" id='submit' onclick="$('#manage-Invoice').submit()">Pay</button>
...
<script>
	...
	$('#manage-Invoice').submit(function(e){
		...
		$.ajax({
			url:'ajax.php?action=save_wholesale',
		    method: 'POST',
		    data: $(this).serialize(),
			success:function(resp){
                console.log(resp);
				if(resp > 0){
					...
					uni_modal("Wholesale Invoice.","print_wholesale.php?id="+resp,"large")
				}
